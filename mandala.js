function mandala_newConfig()
{
   return {
      numPetals:5,        // how many 'slices of pie'
      rotOffset:0.0,   // how much petals are rotate from 0 degrees (0..1)

      // guide config
      numPartialGuides:0, // how many sub-guides to draw between main spokes
      guideOpacity:0.5,   // opacity of guide marks
      // todo : stroke params for guides?
   }
}
